...
import { UserCheck01, Zap, Database01, Activity, Code02, Share07, ShieldTick } from "@untitled-ui/icons-react";
...
const pillars = [
  {
    ...
    description: "Connect real-world developer reputation to the Sui ecosystem using zkLogin. Identities are anchored to permanent, non-transferable OmenBadge objects.",
    icon: UserCheck01,
    tag: "Verified Auth",
    techIcon: GoogleIcon,
  },
  {
    ...
    description: "Utilize Move Programmable Transaction Blocks to enforce real-time reputation gating. Block interaction with malicious contracts at the execution level.",
    icon: Zap,
    tag: "Move PTB Native",
    techIcon: SuiIcon,
  },
  {
    ...
    description: "Store high-volume security audit logs and AI behavior data on Walrus. Cryptographic proofs remain on-chain for O(1) trust verification.",
    icon: Database01,
    tag: "Blob Storage",
    techIcon: WalrusIcon,
  },
  {
    ...
    subtitle: "DeepBook & Beyond",
    description: "Direct integration with DeepBook V3. Protect liquidity and trade execution by filtering participants based on institutional-grade trust scores.",
    icon: Activity,
    tag: "Trust-Gated",
    techIcon: SuiIcon,
  },
              ...
              {pillars.map((pillar, i) => (
                ...
                >
                  <div className="flex items-center justify-between mb-10">
                    ...
                    <div className="px-3 py-1 bg-[#0B0C10] border border-white/5 rounded-full text-[9px] font-mono font-black text-[#49A5BD] uppercase tracking-wider flex items-center gap-1.5 grayscale-0 group-hover:bg-[#49A5BD]/10 transition-colors">
